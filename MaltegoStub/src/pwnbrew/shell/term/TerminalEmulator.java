...
//    }
     ...
     * @return the cursor's current row.
     */
    public final int getRealCursorRow() {
        return getScreen().externalToInternalRow(mCursorRow);
    }
...
//        mUTF8ModeNotify.onUpdate();
    ...
    private void selectGraphicRendition() {
        ...
        for (int i = 0; i <= mArgIndex; i++) {
            ...
            if (code == 0) { // reset
                ...
                Logger.getLogger(TerminalEmulator.class.getName()).log(Level.WARNING, String.format("SGR unknown code %d", code));
            }
        }
    }
    ...
    private boolean checkColor(int color) {
        ...
        if (!result) {
            Logger.getLogger(TerminalEmulator.class.getName()).log(Level.WARNING,
    ...
    private void logError(String error) {
        Logger.getLogger(TerminalEmulator.class.getName()).log(Level.WARNING, error);        
        finishSequence();
    }

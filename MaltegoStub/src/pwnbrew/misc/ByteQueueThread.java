 ...
 * @author user
 */
public class ByteQueueThread extends ManagedRunnable {
    
    private final Queue<byte[]> recByteQueue = new LinkedList<>();   
    private final ByteQueueListener theListener;
    private final int theQueueId;
     ...
     * @param queueId 
     */
    public ByteQueueThread( ByteQueueListener passedListener, int queueId ){
    ...
    protected void go() {
        ...
        while(!shutdownRequested) {
            ...
            if( currByteArray != null ){
                theListener.handleBytesFromQueue( theQueueId, currByteArray );
            }
        }
    }
     ...
     */
    public void addToQueue( byte[] passedByteArray ) {

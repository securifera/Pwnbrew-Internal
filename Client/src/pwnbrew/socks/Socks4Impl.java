...
//        }
//
//        DebugPrinter.printMessage( NAME_Class , "Accepted SOCKS 4 Command: \""+ commName( socksCommand )+"\"" );
//    } 
//    
//    //=========================================================================
//    /**
...
//        
//        DebugPrinter.printMessage( NAME_Class , "Socks 4 reply: \""+replyName( ReplyCode)+"\"" );
//
...
//        DebugPrinter.printMessage( NAME_Class , "Socks 4 - Refuse Command: \""+replyName(errorCode)+"\"" );
...
//
//        DebugPrinter.printMessage( NAME_Class , "Connecting..." );
...
//                DebugPrinter.printMessage( NAME_Class, "Error in BIND() - BIND reip Failed at "+i );
//            }
//        }
//
//        m_ExtLocalIP = IP;
...
//        DebugPrinter.printMessage(UID, "Error - Socks 4 don't support UDP Association!" );
//        DebugPrinter.printMessage(UID, "Check your Software please..." );
